...
public class EducationalAccount extends Account implements Withdrawal, Deposit, FundTransfer {
    ...
    // Constructor for retrieving an existing Educational account from the database
    ...
    public boolean transfer(Account account, double amount) throws IllegalAccountType {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL)) {
            ...
            String updateSenderSQL = "UPDATE " + (this instanceof EducationalAccount ? "EducationalAccount" : "SavingsAccount") + " SET Balance = ? WHERE AccountID = ?";
